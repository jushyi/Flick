...
- [x] 17-06-PLAN.md -- Gap closure: wire screenshot detection, fix read receipt display, replace Firebase imports in NewMessageScreen
...
Plans:
- [x] 19-01-PLAN.md -- SkeletonBase primitive + 9 skeleton screen components + Toast config + react-native-toast-message install
- [x] 19-02-PLAN.md -- imageUrl.ts utility (CDN transforms, signed URL expiry) + EmptyState component
- [x] 19-03-PLAN.md -- useOptimisticMutation helper hook + stale-while-revalidate verification
- [x] 19-04-PLAN.md -- Screen integration (wire skeletons, empty states, image transforms, prefetching into all 9 screens) + human verification
- [x] 19-05-PLAN.md -- Wire optimistic updates into mutation hooks + proactive snap URL refresh integration
...
- [x] 20-01-PLAN.md -- Delete Firebase dead code (26 services, config files) + create shared TypeScript type definitions
- [x] 20-02-PLAN.md -- Install Sentry + create sentryService.ts + port useScreenTrace to Sentry spans
- [x] 20-03-PLAN.md -- TS sweep: constants, utils, styles, config, non-Firebase services, context providers
- [x] 20-04-PLAN.md -- TS sweep: all hooks (camera, messaging, social, interaction)
- [ ] 20-05-PLAN.md -- TS sweep: all components, screens, navigation, App.tsx (3 tasks)
- [ ] 20-08-PLAN.md -- Migration validation: reset script + validation script + D-16 human checkpoint gate
...
| 20. TypeScript Sweep & Firebase Removal | v1.2 | 5/8 | In Progress|  |
