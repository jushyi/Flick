...
| 2     | Message Interactions                   | Reactions, replies, and message deletion          | REACT-01..05, REPLY-01..04, DEL-01..03 | Planned (0/6 plans)     |
...
- [ ] 02-01-PLAN.md — Service layer: sendReaction, removeReaction, sendReply, deleteMessageForMe
- [ ] 02-02-PLAN.md — Cloud Functions: unsendMessage callable, onNewMessage reaction/reply handling, Firestore rules
