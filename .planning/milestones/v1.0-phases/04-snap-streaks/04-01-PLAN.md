...
<task type="auto">
  <name>Task 1: Implement streak Cloud Functions with tests</name>
  <files>functions/index.js, firestore.rules, functions/__tests__/triggers/streakFunctions.test.js</files>
  <action>
Implement the server-side streak engine and its test suite together. Write tests alongside implementation so verification is meaningful at task completion.

**Part A — Implementation in functions/index.js and firestore.rules:**
...
**Part B — Tests in functions/**tests**/triggers/streakFunctions.test.js:**
