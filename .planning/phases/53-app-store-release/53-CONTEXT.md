...
Public App Store release — not unlisted, not promoted. Flick goes live on the App Store as a real, findable app, but there's no marketing push. The initial users come from direct sharing — texting the App Store link to a small group of friends and family.
