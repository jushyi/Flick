...
**Tested:** 2026-01-23 (re-tested after FIX-3)
**Source:** .planning/phases/18.1-batched-darkroom-triage-with-undo/18.1-FIX-3-SUMMARY.md
...
**Severity:** Blocker → Major (downgraded after partial fix)
**Feature:** Card cascade animation during triage
