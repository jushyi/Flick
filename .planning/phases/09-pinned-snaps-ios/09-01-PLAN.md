...
<task type="auto">
  ...
  <action>
    ...
    IMPORTANT: For the SwiftUI layout, keep it simple and functional. The branded pixel-art font can be added later if font embedding in the widget extension proves complex — use system font initially with the correct sizing and dark theme colors.
  </action>
  <verify>
