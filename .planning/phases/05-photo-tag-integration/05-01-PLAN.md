...
must_haves:
  truths:
    ...
    - 'The old notifications collection write and direct push from sendTaggedPhotoNotification are removed'
    - 'addTaggedPhotoToFeed callable creates a new photo document with attribution fields'
