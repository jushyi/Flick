...
| 16-02-02 | 02 | 1 | CORE-05 | unit | `npm test -- useMentionSuggestions` | ❌ W0 | ⬜ pending |
| 16-03-01 | 03 | 1 | CORE-06 | unit | `npm test -- albumService` | ❌ W0 | ⬜ pending |
| 16-03-02 | 03 | 1 | CORE-06 | unit | `npm test -- monthlyAlbumService` | ❌ W0 | ⬜ pending |
| 16-04-01 | 04 | 2 | CORE-08 | unit | `npm test -- blockService` | ❌ W0 | ⬜ pending |
| 16-04-02 | 04 | 2 | CORE-09 | unit | `npm test -- reportService` | ❌ W0 | ⬜ pending |
| 16-05-01 | 05 | 2 | CORE-10 | unit | `npm test -- contactSyncService` | ❌ W0 | ⬜ pending |
...
- [ ] `__tests__/services/friendshipService.test.js` — stubs for CORE-04
- [ ] `__tests__/services/commentService.test.js` — stubs for CORE-05
- [ ] `__tests__/services/albumService.test.js` — stubs for CORE-06
- [ ] `__tests__/services/blockService.test.js` — stubs for CORE-08
- [ ] `__tests__/services/reportService.test.js` — stubs for CORE-09
- [ ] `__tests__/services/contactSyncService.test.js` — stubs for CORE-10
...
| Contact sync matching | CORE-10 | Requires real contacts access | Allow contacts, verify matched friends appear in suggestions |
