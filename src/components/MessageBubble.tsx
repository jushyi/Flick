...
type BubblePosition = { x: number; y: number; width: number; height: number };
...
type ReactionEntry = { senderId: string; messageId: string };
...
type Props = {
  ...
  onDoubleTap?: (message: MessageData) => void;
  onLongPress?: (message: MessageData, position: BubblePosition) => void;
  ...
  highlighted?: boolean;
  findMessageById?: (id: string) => MessageData | null;
